...
public class BookDaoImpl extends BaseDao<Book> implements BookDao {
	...
	public Book getBook(String id) {
		String sql="select id,title,author,price,sales,stock,img_path from bs_books where id=?";
		return getBean(sql, id);
	}

	@Override
	public List<Book> getAllBook() {
		String sql="select id,title,author,price,sales,stock,img_path from bs_books";
	...
	public Page<Book> findBook(Page<Book> page) {
		...
		//获取图书分页信息
		sql = "select id,title,author,price,sales,stock,img_path from bs_books order by id desc limit ?,? ";
	...
	public Page<Book> findBookByPrice(Page<Book> page, int min, int max) {
		...
		//获取图书分页信息
		sql = "select id,title,author,price,sales,stock,img_path from bs_books where price between ? and ? order by id desc limit ?,? ";
